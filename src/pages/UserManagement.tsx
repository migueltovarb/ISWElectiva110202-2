...
import { User, UserPlus, Key, Lock, Shield, Search, MoreVertical, AlertTriangle, Clock, Calendar, Plus, X, Camera, Fingerprint, ArrowRight } from 'lucide-react';
...
export function UserManagement() {
  ...
  const extendedUsers: ExtendedUser[] = allUsers.map(user => ({
    ...
    ] as UserCredential[], // <-- aquí agregamos el casteo
